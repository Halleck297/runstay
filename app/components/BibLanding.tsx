          ...
          <div className="bib-form-card" id="request">
            {complete ? (
              ...
              <fetcher.Form method="post" onSubmit={() => setDismissed(false)}>
                ...
                {race === "Another race" && <label className="bib-field">Race name<input name="otherRace" value={otherRace} onChange={(event) => setOtherRace(event.target.value)} placeholder="e.g. Valencia" required maxLength={120} /></label>}
