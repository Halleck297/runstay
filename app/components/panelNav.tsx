...
export function buildTeamLeaderNavItems(eventUnreadCount: number, pendingRequestsCount: number = 0): PanelNavKeyItem[] {
  return teamLeaderNavItems.map((item) => {
    if (item.to === "/tl-events") {
      return {
        ...item,
    ...
    if (item.to === "/tl-dashboard/requests") {
      return {
        ...item,
