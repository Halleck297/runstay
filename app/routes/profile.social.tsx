    ...
    <div className="min-h-screen bg-[#ECF4FE] bg-[radial-gradient(circle_at_1px_1px,rgba(12,120,243,0.08)_1px,transparent_0)] bg-[size:18px_18px]">
      ...
      <div className="mx-auto max-w-7xl px-4 pt-14 pb-28 sm:px-6 md:pt-16 md:pb-8 lg:px-8">
        <div className="flex flex-col gap-6 md:gap-8 lg:flex-row">
          ...
          <main id="social-main" className="min-w-0 flex-1 scroll-mt-32 rounded-3xl border border-gray-200 bg-white p-4 shadow-[0_10px_35px_-18px_rgba(15,23,42,0.35)] md:scroll-mt-0 md:p-6">
            <div className="mb-6">
            ...
            <Form method="post" className="pb-8 md:pb-8">
              <div className="grid grid-cols-1 gap-x-4 gap-y-3 md:grid-cols-2 md:gap-y-1">
                ...
                <div className="mb-2 space-y-1 md:col-span-2 md:mb-8 md:p-2">
                  <label className="flex items-center gap-2 text-sm font-semibold text-gray-900">
              ...
              <div className="mt-6 px-2">
                <button type="submit" className="btn-primary w-full rounded-full px-6 py-2 text-sm disabled:cursor-not-allowed disabled:opacity-60 md:w-auto" disabled={isSubmitting}>
