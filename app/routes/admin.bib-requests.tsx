...
export default function BibRequestsAdmin() {
  ...
  return <main className="mx-auto max-w-7xl p-4 sm:p-8">
    ...
    <p className="mt-2 text-sm text-gray-600">{count} requests · QR = /go · Site = homepage or language homepage.</p>
