                  ...
                  <div className="flex items-center justify-center gap-3">
                    ...
                    <div className="min-w-0">
                      <div className="flex flex-col gap-1 text-left">
                        ...
                        {listingData.author.user_type !== "admin" && listingData.author.user_type !== "superadmin" && (isEventListing ? eventOrganizer?.is_verified : listingData.author.is_verified) && (
                        ...
                        {isEventListing
                          ...
                          : listingData.author.user_type === "admin" || listingData.author.user_type === "superadmin"
                          ? t("common.website_admin")
                          : listingData.author.user_type === "tour_operator"
                          ? t("common.tour_operator")
                          : t("common.private")}
                        {listingData.author.user_type !== "admin" && listingData.author.user_type !== "superadmin" && (isEventListing ? eventOrganizer?.is_verified : listingData.author.is_verified) && ` · ${t("public_profile.verified")}`}
                      </p>
                      </div>
                    </div>
                  </div>
