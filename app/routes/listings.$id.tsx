...
export async function action({ request, params }: ActionFunctionArgs) {
  ...
  if (actionType === "delete") {
    ...
    const redirectPath = userProfile?.user_type === "agency" ? "/to-panel" : "/my-listings";
...
export default function ListingDetail() {
  ...
  const sellerIsAlwaysPublicRole =
    sellerProfile?.user_type === "agency" || sellerProfile?.platform_role === "team_leader";
                  ...
                  <div className="flex items-center justify-center gap-3">
                    ...
                    <div className="min-w-0">
                      <div className="flex flex-col gap-1 text-left">
                        ...
                        {listingData.author.role !== "admin" && listingData.author.role !== "superadmin" && (isEventListing ? eventOrganizer?.is_verified : listingData.author.is_verified) && (
                        ...
                        {isEventListing
                          ...
                          : listingData.author.role === "admin" || listingData.author.role === "superadmin"
                          ? t("common.website_admin")
                          : listingData.author.user_type === "agency"
                          ? t("common.tour_operator")
                          : t("common.private")}
                        {listingData.author.role !== "admin" && listingData.author.role !== "superadmin" && (isEventListing ? eventOrganizer?.is_verified : listingData.author.is_verified) && ` · ${t("public_profile.verified")}`}
                      </p>
                      </div>
                    </div>
                  </div>
