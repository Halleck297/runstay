...
const PRIVACY: Record<SupportedLocale, LegalPolicyDocument> = {
  en: {
    ...
    sections: [
      { title: "1. Data Controller", paragraphs: ["Data controller details are provided in Runoot legal notices.", "For privacy matters: legal@runoot.com."] },
      ...
      { title: "4. Sharing", paragraphs: ["Data can be shared with service providers that support hosting, authentication, email, security, and analytics.", "For optional analytics, Runoot uses PostHog. Technical collection is routed through a first-party proxy endpoint at /ph.", "Data may be disclosed where required by law or to protect rights and safety."] },
      ...
      { title: "6. Contact", paragraphs: ["Privacy requests: legal@runoot.com."] },
    ],
  },
  it: {
    title: "Privacy Policy",
    ...
    updatedAt: "3 marzo 2026",
    summary: "Questa Policy spiega il trattamento dei dati personali su Runoot.",
    sections: [
      { title: "1. Titolare del trattamento", paragraphs: ["I dati del titolare sono indicati nelle note legali Runoot.", "Per richieste privacy: legal@runoot.com."] },
      ...
      { title: "4. Condivisione", paragraphs: ["I dati possono essere condivisi con fornitori che supportano hosting, autenticazione, email, sicurezza e analytics.", "Per gli analytics opzionali Runoot usa PostHog. La raccolta tecnica passa tramite endpoint proxy first-party /ph.", "I dati possono essere comunicati se richiesto dalla legge o per tutela di diritti e sicurezza."] },
      ...
      { title: "6. Contatti", paragraphs: ["Richieste privacy: legal@runoot.com."] },
    ],
  },
  es: {
    ...
    updatedAt: "3 de marzo de 2026",
    summary: "Esta Politica explica el tratamiento de datos personales en Runoot.",
    sections: [
      { title: "1. Responsable del tratamiento", paragraphs: ["Los datos del responsable figuran en los avisos legales de Runoot.", "Para privacidad: legal@runoot.com."] },
      ...
      { title: "4. Comparticion", paragraphs: ["Los datos pueden compartirse con proveedores de hosting, autenticacion, correo, seguridad y analitica.", "Para analitica opcional Runoot usa PostHog. La recopilacion tecnica se enruta mediante un proxy de primera parte en /ph.", "Tambien pueden revelarse cuando lo exija la ley o para proteger derechos y seguridad."] },
      ...
      { title: "6. Contacto", paragraphs: ["Solicitudes de privacidad: legal@runoot.com."] },
    ],
  },
  fr: {
    ...
    updatedAt: "3 mars 2026",
    summary: "Cette politique explique le traitement des donnees personnelles sur Runoot.",
    sections: [
      { title: "1. Responsable du traitement", paragraphs: ["Les informations du responsable figurent dans les mentions legales de Runoot.", "Pour la confidentialite: legal@runoot.com."] },
      ...
      { title: "4. Partage", paragraphs: ["Les donnees peuvent etre partagees avec des prestataires pour hebergement, authentification, email, securite et analytique.", "Pour l'analytique optionnelle, Runoot utilise PostHog. La collecte technique passe par un endpoint proxy first-party /ph.", "Elles peuvent aussi etre divulguees si la loi l'exige ou pour proteger droits et securite."] },
      ...
      { title: "6. Contact", paragraphs: ["Demandes de confidentialite: legal@runoot.com."] },
    ],
  },
  de: {
    ...
    updatedAt: "3. Marz 2026",
    summary: "Diese Richtlinie erklart die Verarbeitung personenbezogener Daten bei Runoot.",
    sections: [
      { title: "1. Verantwortlicher", paragraphs: ["Angaben zum Verantwortlichen stehen in den rechtlichen Hinweisen von Runoot.", "Fur Datenschutzanfragen: legal@runoot.com."] },
      ...
      { title: "4. Weitergabe", paragraphs: ["Daten konnen mit Dienstleistern fur Hosting, Authentifizierung, E-Mail, Sicherheit und Analyse geteilt werden.", "Fur optionale Analyse nutzt Runoot PostHog. Die technische Erfassung wird uber einen First-Party-Proxy-Endpunkt unter /ph geleitet.", "Eine Offenlegung kann erfolgen, wenn dies gesetzlich erforderlich ist oder Rechte und Sicherheit zu schutzen sind."] },
      ...
      { title: "6. Kontakt", paragraphs: ["Datenschutzanfragen: legal@runoot.com."] },
    ],
  },
  nl: {
    title: "Privacybeleid",
    ...
    sections: [
      { title: "1. Verwerkingsverantwoordelijke", paragraphs: ["Gegevens van de verantwoordelijke staan in de juridische kennisgeving van Runoot.", "Voor privacyverzoeken: legal@runoot.com."] },
      ...
      { title: "4. Delen van gegevens", paragraphs: ["Gegevens kunnen worden gedeeld met dienstverleners voor hosting, authenticatie, e-mail, beveiliging en analytics.", "Voor optionele analytics gebruikt Runoot PostHog. Technische verzameling loopt via een first-party proxy-endpoint op /ph.", "Openbaarmaking kan plaatsvinden wanneer wettelijk vereist of ter bescherming van rechten en veiligheid."] },
      ...
      { title: "6. Contact", paragraphs: ["Privacyverzoeken: legal@runoot.com."] },
    ],
  },
  pt: {
    ...
    updatedAt: "3 de marco de 2026",
    summary: "Esta politica explica como dados pessoais sao tratados na Runoot.",
    sections: [
      { title: "1. Controlador", paragraphs: ["Os dados do controlador estao nas notas legais da Runoot.", "Para privacidade: legal@runoot.com."] },
      ...
      { title: "4. Compartilhamento", paragraphs: ["Dados podem ser compartilhados com prestadores de hospedagem, autenticacao, email, seguranca e analitica.", "Para analitica opcional a Runoot usa PostHog. A coleta tecnica passa por um endpoint proxy de primeira parte em /ph.", "Tambem podem ser divulgados quando exigido por lei ou para proteger direitos e seguranca."] },
      ...
      { title: "6. Contato", paragraphs: ["Solicitacoes de privacidade: legal@runoot.com."] },
    ],
  },
};
...
const COOKIES: Record<SupportedLocale, LegalPolicyDocument> = {
  en: {
    ...
    sections: [
      ...
      { title: "4. Third Parties", paragraphs: ["Some cookies can be set by trusted third-party providers used for authentication, hosting, or analytics.", "For optional analytics, Runoot uses PostHog. Requests are proxied through /ph on the Runoot domain."] },
      { title: "5. Duration", paragraphs: ["Cookies can be session cookies or persistent cookies with a defined expiration period."] },
      { title: "6. Contact", paragraphs: ["For cookie questions: legal@runoot.com."] },
    ],
  },
  it: {
    title: "Cookie Policy",
    ...
    sections: [
      ...
      { title: "4. Terze parti", paragraphs: ["Alcuni cookie possono essere impostati da fornitori terzi affidabili usati per autenticazione, hosting o analytics.", "Per gli analytics opzionali Runoot usa PostHog. Le richieste sono instradate tramite /ph sul dominio Runoot."] },
      { title: "5. Durata", paragraphs: ["I cookie possono essere di sessione o persistenti con una scadenza definita."] },
      { title: "6. Contatti", paragraphs: ["Per domande sui cookie: legal@runoot.com."] },
    ],
  },
  es: {
    ...
    sections: [
      ...
      { title: "4. Terceros", paragraphs: ["Algunas cookies pueden ser establecidas por proveedores de confianza usados para autenticacion, hosting o analitica.", "Para analitica opcional Runoot usa PostHog. Las solicitudes se enrutan mediante /ph en el dominio Runoot."] },
      { title: "5. Duracion", paragraphs: ["Las cookies pueden ser de sesion o persistentes con una expiracion definida."] },
      { title: "6. Contacto", paragraphs: ["Para consultas sobre cookies: legal@runoot.com."] },
    ],
  },
  fr: {
    ...
    sections: [
      ...
      { title: "4. Tiers", paragraphs: ["Certains cookies peuvent etre definis par des prestataires tiers de confiance utilises pour authentification, hebergement ou analytique.", "Pour l'analytique optionnelle, Runoot utilise PostHog. Les requetes sont acheminees via /ph sur le domaine Runoot."] },
      { title: "5. Duree", paragraphs: ["Les cookies peuvent etre de session ou persistants avec une date d'expiration definie."] },
      { title: "6. Contact", paragraphs: ["Pour les questions cookies: legal@runoot.com."] },
    ],
  },
  de: {
    ...
    sections: [
      ...
      { title: "4. Drittanbieter", paragraphs: ["Einige Cookies konnen von vertrauenswurdigen Drittanbietern fur Authentifizierung, Hosting oder Analyse gesetzt werden.", "Fur optionale Analyse nutzt Runoot PostHog. Anfragen werden uber /ph auf der Runoot-Domain geleitet."] },
      { title: "5. Speicherdauer", paragraphs: ["Cookies konnen Sitzungs-Cookies oder persistente Cookies mit definierter Laufzeit sein."] },
      { title: "6. Kontakt", paragraphs: ["Fragen zu Cookies: legal@runoot.com."] },
    ],
  },
  nl: {
    title: "Cookiebeleid",
    ...
    sections: [
      ...
      { title: "4. Derde partijen", paragraphs: ["Sommige cookies kunnen worden geplaatst door vertrouwde derde partijen voor authenticatie, hosting of analytics.", "Voor optionele analytics gebruikt Runoot PostHog. Verzoeken lopen via /ph op het Runoot-domein."] },
      { title: "5. Bewaartermijn", paragraphs: ["Cookies kunnen sessiecookies of persistente cookies met een bepaalde looptijd zijn."] },
      { title: "6. Contact", paragraphs: ["Vragen over cookies: legal@runoot.com."] },
    ],
  },
  pt: {
    title: "Politica de Cookies",
    ...
    sections: [
      ...
      { title: "4. Terceiros", paragraphs: ["Alguns cookies podem ser definidos por provedores terceiros confiaveis usados para autenticacao, hospedagem ou analitica.", "Para analitica opcional a Runoot usa PostHog. As requisicoes passam por /ph no dominio Runoot."] },
      { title: "5. Duracao", paragraphs: ["Cookies podem ser de sessao ou persistentes com prazo de expiracao definido."] },
      { title: "6. Contato", paragraphs: ["Duvidas sobre cookies: legal@runoot.com."] },
    ],
  },
};
