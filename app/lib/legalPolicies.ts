...
const PRIVACY: Record<SupportedLocale, LegalPolicyDocument> = {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Analytics: Google Analytics 4 (Google), enabled only after your consent to optional analytics.",
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Analytics: Google Analytics 4 (Google), attivo solo dopo il consenso alle statistiche opzionali.",
        ],
      },
      {
  ...
  nl: {
    ...
    sections: [
      ...
      { title: "4. Delen van gegevens", paragraphs: ["Wij kunnen uw gegevens delen met de volgende categorieen derde verwerkers, die namens ons handelen op basis van contractuele verwerkingsovereenkomsten:"], bullets: ["Hosting en infrastructuur: cloudhosting-aanbieders (Supabase / AWS).", "Authenticatie: identiteits- en toegangsbeheerdiensten (Supabase Auth).", "E-mailverzending: transactionele e-mailaanbieders (Resend).", "Analyse: Google Analytics 4 (Google), alleen actief na uw toestemming voor optionele statistieken."] },
...
const COOKIES: Record<SupportedLocale, LegalPolicyDocument> = {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Analytics cookies (optional): used to understand how users interact with the platform and improve performance and user experience. Runoot uses Google Analytics 4 (Google) for optional analytics; these cookies are only set with your explicit consent.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "For optional analytics, Runoot uses Google Analytics 4 (Google).",
        ],
      },
      {
        ...
        paragraphs: [
          ...
          "Authentication cookies (sb-*) persist for the duration of your login session. The consent cookie (cookie_consent) persists for 6 months.",
        ],
      },
      {
        title: "6. Contact",
  ...
  it: {
    ...
    sections: [
      ...
      { title: "2. Categorie di cookie", paragraphs: ["Runoot utilizza le seguenti categorie di cookie:"], bullets: ["Cookie essenziali: necessari per il funzionamento base della piattaforma. Includono cookie di sessione di autenticazione (sb-*), preferenza lingua (locale) e tracciamento consenso (cookie_consent). Non possono essere disattivati in quanto necessari al funzionamento della piattaforma.", "Cookie analitici (opzionali): utilizzati per comprendere come gli utenti interagiscono con la piattaforma e migliorare prestazioni ed esperienza utente. Runoot usa Google Analytics 4 (Google) per analytics opzionali; questi cookie vengono impostati solo con il tuo consenso esplicito."] },
      ...
      { title: "4. Cookie di terze parti", paragraphs: ["Alcuni cookie possono essere impostati da fornitori terzi di fiducia utilizzati per autenticazione, hosting o analytics.", "Per gli analytics opzionali, Runoot usa Google Analytics 4 (Google)."] },
  ...
  es: {
    ...
    updatedAt: "16 de septiembre de 2026",
    ...
    sections: [
      ...
      { title: "4. Cookies de terceros", paragraphs: ["Algunas cookies pueden ser configuradas por proveedores de servicios terceros de confianza utilizados para autenticacion, alojamiento o analitica.", "Para analitica opcional, Runoot usa Google Analytics 4 (Google)."] },
      { title: "5. Duracion de las cookies", paragraphs: ["Las cookies de sesion se eliminan al cerrar el navegador. Las cookies persistentes permanecen en tu dispositivo durante un periodo definido o hasta que las elimines manualmente.", "Las cookies de autenticacion (sb-*) persisten durante la sesion de inicio de sesion. La cookie de consentimiento (cookie_consent) persiste durante 6 meses."] },
  ...
  de: {
    ...
    sections: [
      ...
      { title: "4. Drittanbieter-Cookies", paragraphs: ["Einige Cookies koennen von vertrauenswuerdigen Drittanbietern fuer Authentifizierung, Hosting oder Analyse gesetzt werden.", "Fuer optionale Analysen verwendet Runoot Google Analytics 4 (Google)."] },
      { title: "5. Cookie-Dauer", paragraphs: ["Sitzungscookies werden beim Schliessen des Browsers geloescht. Persistente Cookies verbleiben auf Ihrem Geraet fuer einen definierten Zeitraum oder bis Sie sie manuell loeschen.", "Authentifizierungscookies (sb-*) bestehen fuer die Dauer Ihrer Anmeldesitzung. Das Einwilligungscookie (cookie_consent) besteht fuer 6 Monate."] },
  ...
  nl: {
    ...
    sections: [
      ...
      { title: "2. Cookiecategorieen", paragraphs: ["Runoot gebruikt de volgende categorieen cookies:"], bullets: ["Essentiele cookies: vereist voor de basisfunctionaliteit van het platform. Deze omvatten authenticatie-sessiecookies (sb-*), taalvoorkeur (locale) en toestemmingstracking (cookie_consent). Deze kunnen niet worden uitgeschakeld omdat ze nodig zijn voor de werking van het platform.", "Analytics-cookies (optioneel): gebruikt om te begrijpen hoe gebruikers met het platform omgaan en om prestaties en gebruikerservaring te verbeteren. Runoot gebruikt Google Analytics 4 (Google) voor optionele analyse; deze cookies worden alleen geplaatst met uw uitdrukkelijke toestemming."] },
      ...
      { title: "4. Cookies van derden", paragraphs: ["Sommige cookies kunnen worden geplaatst door vertrouwde externe dienstverleners die worden gebruikt voor authenticatie, hosting of analyse.", "Voor optionele analyse gebruikt Runoot Google Analytics 4 (Google)."] },
      { title: "5. Cookieduur", paragraphs: ["Sessiecookies worden verwijderd wanneer u uw browser sluit. Persistente cookies blijven op uw apparaat voor een bepaalde periode of totdat u ze handmatig verwijdert.", "Authenticatiecookies (sb-*) blijven bestaan voor de duur van uw inlogsessie. De toestemmingscookie (cookie_consent) blijft 6 maanden bestaan."] },
  ...
  pt: {
    ...
    sections: [
      ...
      { title: "4. Cookies de terceiros", paragraphs: ["Alguns cookies podem ser definidos por provedores de servicos terceiros confiaveis utilizados para autenticacao, hospedagem ou analise.", "Para analise opcional, a Runoot usa o Google Analytics 4 (Google)."] },
      { title: "5. Duracao dos cookies", paragraphs: ["Cookies de sessao sao excluidos ao fechar o navegador. Cookies persistentes permanecem em seu dispositivo por um periodo definido ou ate voce exclui-los manualmente.", "Os cookies de autenticacao (sb-*) persistem durante a sessao de login. O cookie de consentimento (cookie_consent) persiste por 6 meses."] },
